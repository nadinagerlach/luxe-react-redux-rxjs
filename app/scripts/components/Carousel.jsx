...
export default class Carousel extends React.Component {
  constructor() {
    ...
    this.state = {
      ...
      currentSlideCaption: this.props.currentSlideCaption,
      dragging: false,
      frameWidth: 0,
      left: 0,
      slideCount: 0,
        ...
        typeof func === 'function' && (
          ...
          >
            {func({
              ...
              currentSlideCaption: this.state.currentSlideCaption,
...
Carousel.propTypes = {
  ...
  currentSlideCaption: PropTypes.string,
...
Carousel.defaultProps = {
  ...
  heightMode: 'first',
  slideIndex: 0,
  currentSlideCaption: 'Snap Your Bands',
  slidesToScroll: 1,
  slidesToShow: 1,
  style: {},
