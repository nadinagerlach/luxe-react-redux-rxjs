  ...
  render() {
    ...
    return (
      <div className="app__container">
        ...
        <Slider {...settings}>
          <div className="slide">
            <div id={img1} className="slide__image" alt="Lemonhead" />
            <div className="slide__text">
              <h2>Lemonhead</h2>
              <p><a href="https://www.getlemonhead.com/media/" target="_blank" tabIndex="-1">www.lemonhead.la </a>
              </p>
            </div>
          </div>
          <div className="slide">
          ...
          <div className="slide">
            ...
            <div className="slide__text">
              <h2>Bobalu Nuts</h2>
              <p><a href="http://bobalunuts.com/" target="_blank" tabIndex="-1">www.bobalunuts.com</a>
              </p>
