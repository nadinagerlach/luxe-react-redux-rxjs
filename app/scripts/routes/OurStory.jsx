          ...
          <div className="app__container">
            <div className="full-width-image-2">
              ...
              <div className="row our-story">
                ...
                <img className="our-story-image img-fluid mx-auto wow fadeInLeft animated" src="https://res.cloudinary.com/dygn/image/upload/v1516759908/1977_my3iiu.jpg" alt="1977"></img>
                </div>
              </div>
              ...
              <div className="row our-story">
                ...
                <img className="our-story-image img-fluid mx-auto wow fadeInRight animated" src="https://res.cloudinary.com/dygn/image/upload/v1516759912/1995_mbtvxt.jpg" alt="1995"></img>
                </div>
              </div>
              ...
              <div className="row our-story">
                ...
                <div className="col-md-5 order-md-1">
                  <img className="our-story-image img-fluid mx-auto wow fadeInRight animated" src="https://res.cloudinary.com/dygn/image/upload/v1516759943/1996_sinwf3.jpg" alt="1996"></img>
                </div>
              </div>
              ...
              <div className="row our-story">
                ...
                <div className="col-md-5">
                  <img className="our-story-image img-fluid mx-auto wow fadeInLeft animated" src="https://res.cloudinary.com/dygn/image/upload/v1516760386/2000_htr7hv.jpg" alt="2000"></img>
                </div>
              </div>
              ...
              <div className="row our-story ">
                ...
                <div className="col-md-5 order-md-1">
                  <img className="our-story-image img-fluid mx-auto wow fadeInRight animated" src="https://res.cloudinary.com/dygn/image/upload/v1516759909/2006_mgy8rk.jpg" alt="2006"></img>
                </div>
              </div>
              ...
              <div className="row our-story">
                ...
                <div className="col-md-5">
                  <img className="our-story-image img-fluid mx-auto wow fadeInLeft animated" src="https://res.cloudinary.com/dygn/image/upload/v1516759924/2017_fwqk2l.jpg" alt="2017"></img>
                </div>
              </div>
            </div>
          </div>
