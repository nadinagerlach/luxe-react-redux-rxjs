      ...
      <div key="OurStory" className="app__route">
          ...
          <div className="app__page__intro__cell" style={intro1}>
            ...
            <div className="app__page__intro__navigation">
              <div className="app__page__intro__navigation__button">
                <Link smooth to="/our-story/#1977" className="button" ><div className="button-cell"><span className="button-text-wrapper">1975-1985</span></div></Link>
              </div>
              <div className="app__page__intro__navigation__button">
                <Link smooth to="/our-story/#1995" className="button" ><div className="button-cell"><span className="button-text-wrapper">1986-1995</span></div></Link>
              </div>
              <div className="app__page__intro__navigation__button">
                <Link smooth to="/our-story/#Espanola" className="button" ><div className="button-cell"><span className="button-text-wrapper">1996-2005</span></div></Link>
              </div>
              <div className="app__page__intro__navigation__button">
        ...
        <div className="app__page__grid ">
          <div className="app__page__grid__cell u-med-1of2 u-small-full">
            <div className="Demo">
              <h4 className={`app__page__grid__subcategory ${fadeUp}`} id="1977" >1977-1985</h4>
              <h1 className={`app__page__grid__heading ${fadeUp}`} id="1977" >Our Founding</h1>
              <p className={`lead ${fadeUp}`}>The early years that began the JM legacy.</p>
              <p className={`line-div ${fadeUp}`} >&#8214;</p>
              <h2 className={`app__page__grid__subtitle ${fadeUp}`} id="1977" >1977</h2>
              <p className={`lead ${fadeUp}`}>Anto Mahroukian, current President of JM Tobacco, was born.              </p>
              <p className={`line-div ${fadeUp}`}>&#8214;</p>
              <h2 className={`app__page__grid__subtitle ${fadeUp}`} id="1995" >1995</h2>
        ...
        <div className="app__page__grid" style={espanola}>
          <div className="app__page__grid__cell u-med-1of2 u-small-full align__center">
          ...
          <div className="app__page__grid__cell u-med-1of2 u-small-full">
            <div className="Demo">
              <h4 className={`app__page__grid__subcategory  ${fadeUp}`} id="1977" >1977-1985</h4>
              <h1 className={`app__page__grid__heading ${fadeUp}`} id="1977" >Coming of Age</h1>
              <p className={`lead ${fadeUp}`}>The JM brand comes of age, transforming to an American daily indulgence.</p>
              <p className={`line-div ${fadeUp}`}>&#8214;</p>
              <h2 className={`app__page__grid__subtitle ${fadeUp}`} id="Espanola" >1996</h2>
              <p className={`lead ${fadeUp}`}>JM Tobacco Releases its first cigar: Espanola Gold Label.</p>
              <p className={`line-div ${fadeUp}`}>&#8214;</p>
              <h2 className={`app__page__grid__subtitle ${fadeUp}`} id="2000" >2000</h2>
              <p className={`lead ${fadeUp}`}>JM's Dominican is launched.</p>
              <img className="app__page__grid__image wow fadeInLeft animated" src="https://res.cloudinary.com/dygn/image/upload/v1516760386/2000_htr7hv.jpg" alt="2000" />
              <p className={`line-div ${fadeUp}`}>&#8214;</p>
            </div>
          </div>
        </div>
        <div className="app__page__grid " style={zoidian}>
          <div className="app__page__grid__cell u-med-1of2 u-small-full">
            <div className="Demo">
              <h4 className={`app__page__grid__subcategory ${fadeUp}`} id="1977" >1977-1985</h4>
              <h1 className={`app__page__grid__heading ${fadeUp}`} id="1977" >Modern Era</h1>
              <p className={`lead ${fadeUp}`}>An exciting new era of innovation begins with Anto Mahroukian taking formal leadership of the company, and continues with the biggest expansion to our family of brands with Zoidian cigars.</p>
              <p className={`line-div ${fadeUp}`}>&#8214;</p>
              <h2 className={`app__page__grid__subtitle ${fadeUp}`} id="2006" >2006</h2>
              <p className={`lead ${fadeUp}`}>Anto Mahroukian takes over as President of JM Tobacco, Inc.</p>
              <img className="app__page__grid__image img-fluid mx-auto wow fadeInRight animated" src="https://res.cloudinary.com/dygn/image/upload/v1516759909/2006_mgy8rk.jpg" alt="2006" />
              <p className={`line-div ${fadeUp}`}>&#8214;</p>
              <h2 className={`app__page__grid__subtitle ${fadeUp}`} id="2017" >2017</h2>
              <p className={`lead ${fadeUp}`}>JM Tobacco introduces Zoidian cigars.</p>
            </div>
          </div>
          <div className="app__page__grid__cell u-med-1of2 align__bottom u-small-full">
